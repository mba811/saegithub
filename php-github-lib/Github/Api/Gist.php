...
/**
 * Listing Gists, searching, editing and closing your projects issues.
 *
 * @link      http://develop.github.com/p/gist.html
 * @author    Stigliew <stigliew at gmail dot com>
 * @license   MIT License
 */
class Github_Api_Gist extends Github_Api
{
     ...
     * @return  array                     list of gists found
     */
    public function getList($username)
    {
        $response = $this->get('gists/'.urlencode($username));
